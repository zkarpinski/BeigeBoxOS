 ...
 *   Total JS         : ~6 700 KB  (Next.js dev chunks grew with app surface)
 *   Total CSS        : ~180 KB
...
test('JS and CSS transfer sizes are within budget', async ({ page }) => {
  ...
  // Total JS under 7 500 KB (dev-mode budget; production will be ~10× smaller)
  expect(jsBytes).toBeLessThan(7500 * 1024);
