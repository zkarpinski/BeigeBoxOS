...
import { PalmOsShellProvider } from './PalmOsShellContext';
...
export function PalmDesktop() {
  ...
  return (
    <PalmOsShellProvider currentApp={currentApp} openApp={openApp} goHome={goHome}>
      <PalmFrame
        onHomeClick={goHome}
        ...
        <div className="flex h-full w-full flex-col bg-white" style={{ position: 'relative' }}>
          {!hideStatusBar && (
            <PalmStatusBar
              ...
              onTitleClick={
                currentApp === 'space_trader' ? () => setMenuOpen((o) => !o) : undefined
              }
                  ...
                  <div className="flex flex-col items-center gap-4 p-3 text-black">
                    <div className="flex items-start gap-3 w-full">
                      ...
                      <span className="text-xs leading-tight text-left mt-1">
                        The '
                        {currentApp.charAt(0).toUpperCase() +
                          currentApp.slice(1).replace(/_/g, ' ')}
