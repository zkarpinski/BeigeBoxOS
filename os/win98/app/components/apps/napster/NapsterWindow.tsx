...
// TODO(Phase 3.4): Napster content extraction — see packages/apps/napster/NapsterApp.tsx.
        ...
        <div className="napster-library-toolbar">
          <button
            ...
            onClick={() => {
              ...
              // SECURITY: Using shared utility for opening external links.
              // This ensures noopener,noreferrer are included to prevent window-opener hijacking.
