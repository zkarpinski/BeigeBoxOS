...
/**
 * Exposes `window.Windows98` for legacy / helper code — must render inside WindowManagerProvider.
 */
import { useEffect } from 'react';
import type { AppConfig } from '@retro-web/core/types/app-config';
import { useWindowManager, Z_FOCUSED, type DialogType } from '@retro-web/core/context';

export function Windows98GlobalShim({ registry }: { registry: AppConfig[] }) {
  const {
    apps,
    showApp,
    hideApp,
