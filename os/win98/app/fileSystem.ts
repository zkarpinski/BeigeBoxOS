/**
 * Win98 virtual filesystem — CRUD via @retro-web/core/fs, Win98-specific
...
function buildDefaultTree() {
  return {
    'C:': { type: 'folder' as const, children: ['Windows', 'Program Files', 'My Documents'] },
    'C:\\Windows': { type: 'folder' as const, children: ['Desktop', 'System', 'Temp', 'Fonts'] },
    'C:\\Windows\\Desktop': { type: 'folder' as const, children: ['TODO.txt', 'My Resume.doc'] },
    'C:\\Windows\\Desktop\\TODO.txt': { type: 'file' as const, content: DEFAULT_TODO_CONTENT },
    'C:\\Windows\\Desktop\\My Resume.doc': { type: 'file' as const, contentKey: 'resume' },
    'C:\\Windows\\System': { type: 'folder' as const, children: [] },
    'C:\\Windows\\Temp': { type: 'folder' as const, children: [] },
    'C:\\Windows\\Fonts': { type: 'folder' as const, children: [] },
    'C:\\My Documents': { type: 'folder' as const, children: ['My Resume.doc'] },
    'C:\\My Documents\\My Resume.doc': { type: 'file' as const, contentKey: 'resume' },
