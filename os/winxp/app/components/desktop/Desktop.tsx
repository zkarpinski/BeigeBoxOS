...
import { LimeWireWindow } from '../apps/limewire';
import { Itunes8Window } from '../apps/itunes8';
    ...
    >
      ...
      <OsShellProvider value={{ AppWindow, TitleBar, MenuBar, writeFile }}>
        ...
        <div className="seo-intro" aria-hidden="true">
          ...
          <p>
            A nostalgic Windows XP desktop in your browser. Open Winamp, iTunes, LimeWire, AIM,
            Minesweeper, Paint, Notepad, Calculator, and more. By Zachary Karpinski.
          </p>
        </div>
